...
@section('page-header')
				...
				<div class="breadcrumb-header justify-content-between">
					<div class="my-auto">
						<div class="d-flex">
							<h4 class="content-title mb-0 my-auto">Invoices List</h4><span class="text-muted mt-1 tx-13 mr-2 mb-0">/ Details</span>
						</div>
					</div>
                            ...
                            <div class="tab-content">
                                        ...
                                        <table class="table table-striped" style="text-align:center">
                                            <tbody>
                                                ...
                                                <tr>
                                                    ...
                                                    <th scope="row"> <strong>Amount Collection</strong> </th>
                                                    <td>{{ $invoices->amount_collection }}</td>
                                                    <th scope="row"> <strong>Amount Commission</strong> </th>
                                                ...
                                                <tr>
                                                    <th scope="row"> <strong>Rate Vat</strong></th>
                                                    <td>{{ $invoices->rate_vat }}</td>
                                                    <th scope="row">  <strong>Value Vat</strong></th>
                                ...
                                <div class="tab-pane" id="tab6">
                                    ...
                                    <div class="card card-statistics">
                                            ...
                                            <div class="card-body">
                                                <p class="text-danger">Ext. * pdf, jpeg ,.jpg , png </p>
            ...
            <div class="modal-content">
                ...
                <form action="{{ route('delete_file') }}" method="post">
                    ...
                    <div class="modal-body">
                        <p class="text-center">
                        <h6 style="color:red"> ?Are you sure you want to delete </h6>
                        </p>
